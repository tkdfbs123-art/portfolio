...
const Portfolio = () => {
  ...
  const certifications = [
    ...
    { name: '전산회계 2급', issuer: '한국세무사회' },
    { name: '사회복지사 2급', issuer: '보건복지부' },
    { name: '운전면허 1종', issuer: '경찰청' }
  ];
        ...
        <div className="certifications-grid">
          {certifications.map((cert, index) => (
            <div key={index} className="certification-card">
              ...
              <p className="certification-issuer">발급기관: {cert.issuer}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {archModal.isOpen && (
        <div className="video-modal" onClick={closeArchModal}>
          <div className="arch-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="video-modal-close" style={{ top: '-45px', right: '0' }} onClick={closeArchModal}>×</button>

            {archModal.type === 'kiwi' && (
              <>
                <p className="arch-modal-title">🏗️ KIWI — 시스템 아키텍처</p>
                <div className="arch-diagram">

                  <div className="arch-section-label">① 데이터 수집</div>
                  <div className="arch-row">
                    <div className="arch-box crawler">App Store 리뷰</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box crawler">Google Play Scraper</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box preprocess">KSSDS 문장 분리</div>
                  </div>

                  <div className="arch-section-label">② 라벨링 & 모델 학습</div>
                  <div className="arch-row">
                    <div className="arch-box preprocess">Gemini API 1차 라벨링</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box model">KcELECTRA 파인튜닝</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box model">ABSA 분석 모델</div>
                  </div>

                  <div className="arch-section-label">③ 백엔드 & DB</div>
                  <div className="arch-row">
                    <div className="arch-box backend">Django MTV 백엔드</div>
                    <div className="arch-arrow">⇄</div>
                  ...
                  <div className="arch-section-label">④ RAG 챗봇</div>
                  <div className="arch-row">
                    <div className="arch-box rag">bge-m3 임베딩</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box rag">ChromaDB 벡터 저장</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box rag">Hybrid Search + Reranking</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box rag">Gemini 2.5 Flash 응답</div>
                  </div>

                  <div className="arch-section-label">⑤ 출력</div>
                  <div className="arch-row">
                    <div className="arch-box frontend">프론트엔드 대시보드</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box report">자동 보고서 생성</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box report">PDF 다운로드</div>
                  </div>

                  <div className="arch-legend">
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#ef4444' }}></div>크롤링</div>
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#f97316' }}></div>전처리</div>
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#eab308' }}></div>모델</div>
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#22c55e' }}></div>백엔드</div>
                    ...
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#14b8a6' }}></div>출력</div>
                  </div>
                </div>
              </>
            )}
            ...
            {archModal.type === 'feelconomy' && (
              <>
                <p className="arch-modal-title">🏗️ 희노애애락도 ROCK이다 — 시스템 아키텍처</p>
                <div className="arch-diagram">

                  <div className="arch-section-label">① 데이터 수집</div>
                  <div className="arch-row">
                    <div className="arch-box crawler">네이버 지도</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box crawler">Selenium 크롤링</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box preprocess">VPN 봇 탐지 우회</div>
                  </div>

                  <div className="arch-section-label">② 데이터 처리 & 저장</div>
                  <div className="arch-row">
                    <div className="arch-box preprocess">리뷰 전처리</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box database">MySQL Transaction</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box preprocess">중복 검사 로직</div>
                  </div>

                  <div className="arch-section-label">③ 감정 분석 모델</div>
                  <div className="arch-row">
                    <div className="arch-box model">실제 리뷰 라벨링</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box model">KoBERT 파인튜닝</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box model">희·노·애·애·락 분류</div>
                  </div>

                  <div className="arch-section-label">④ 백엔드 & API</div>
                  <div className="arch-row">
                    <div className="arch-box backend">Flask RESTful API</div>
                    <div className="arch-arrow">⇄</div>
                    <div className="arch-box database">MySQL DB</div>
                    <div className="arch-arrow">⇄</div>
                    <div className="arch-box api">날씨 / 운세 API</div>
                  </div>

                  <div className="arch-section-label">⑤ 추천 & 출력</div>
                  <div className="arch-row">
                    <div className="arch-box frontend">사용자 감정 입력</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box frontend">맞춤형 맛집 추천</div>
                    <div className="arch-arrow">→</div>
                    <div className="arch-box report">결과 표시</div>
                  </div>
                  ...
                  <div className="arch-legend">
                    ...
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#22c55e' }}></div>백엔드</div>
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#3b82f6' }}></div>DB</div>
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#8b5cf6' }}></div>프론트엔드</div>
                    <div className="arch-legend-item"><div className="arch-legend-dot" style={{ background: '#14b8a6' }}></div>출력</div>
                  </div>
                </div>
              </>
